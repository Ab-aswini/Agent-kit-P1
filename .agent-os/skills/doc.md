...
|---------|-----------|-------|
| **Workspace** | `<workspace-root>/.agent-os/skills/` | Chỉ có trong một dự án cụ thể |
...
```bash
mkdir -p .agent-os/skills/license-header-adder/resources
```

### Bước 2: Tạo file template

**`.agent-os/skills/license-header-adder/resources/HEADER.txt`**:
...
**`.agent-os/skills/license-header-adder/SKILL.md`**:

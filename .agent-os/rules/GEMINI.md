...
- Agents: `.agent-os/` (Project)
- Skills: `.agent-os/skills/` (Project)
- Runtime Scripts: `.agent-os/skills/<skill>/scripts/`
...
> 🔴 **Agents & Skills can invoke ANY script** via `python .agent-os/skills/<skill>/scripts/<script>.py`
...
> 🔴 **MAESTRO OVERRIDE:** Do NOT "fix" technical edges or high-density layouts into generic SaaS templates. Respect the "System Mono" and "Elite Facility" vibe.

...
VERIFICATION_SUITE = [
    # P0: Security (CRITICAL)
    {
        "category": "Security",
        "checks": [
            ("Security Scan", ".agent-os/skills/vulnerability-scanner/scripts/security_scan.py", True),
            ("Dependency Analysis", ".agent-os/skills/vulnerability-scanner/scripts/dependency_analyzer.py", False),
        ]
    },
    ...
    # P1: Code Quality (CRITICAL)
    {
        ...
        "checks": [
            ("Lint Check", ".agent-os/skills/lint-and-validate/scripts/lint_runner.py", True),
            ("Type Coverage", ".agent-os/skills/lint-and-validate/scripts/type_coverage.py", False),
        ]
    },
    ...
    # P2: Data Layer
    {
        "category": "Data Layer",
        "checks": [
            ("Schema Validation", ".agent-os/skills/database-design/scripts/schema_validator.py", False),
        ]
    },
    ...
    # P3: Testing
    {
        "category": "Testing",
        "checks": [
            ("Test Suite", ".agent-os/skills/testing-patterns/scripts/test_runner.py", False),
        ]
    },
    ...
    # P4: UX & Accessibility
    {
        ...
        "checks": [
            ("UX Audit", ".agent-os/skills/frontend-design/scripts/ux_audit.py", False),
            ("Accessibility Check", ".agent-os/skills/frontend-design/scripts/accessibility_checker.py", False),
        ]
    },
    ...
    # P5: SEO & Content
    {
        ...
        "checks": [
            ("SEO Check", ".agent-os/skills/seo-fundamentals/scripts/seo_checker.py", False),
            ("GEO Check", ".agent-os/skills/geo-fundamentals/scripts/geo_checker.py", False),
        ]
    },
    ...
    # P6: Performance (requires URL)
    {
        ...
        "requires_url": True,
        "checks": [
            ("Lighthouse Audit", ".agent-os/skills/performance-profiling/scripts/lighthouse_audit.py", True),
            ("Bundle Analysis", ".agent-os/skills/performance-profiling/scripts/bundle_analyzer.py", False),
        ]
    },
    ...
    # P7: E2E Testing (requires URL)
    {
        ...
        "requires_url": True,
        "checks": [
            ("Playwright E2E", ".agent-os/skills/webapp-testing/scripts/playwright_runner.py", False),
        ]
    },
    ...
    # P8: Mobile (if applicable)
    {
        "category": "Mobile",
        "checks": [
            ("Mobile Audit", ".agent-os/skills/mobile-design/scripts/mobile_audit.py", False),
        ]
    },
    ...
    # P9: Internationalization
    {
        ...
        "checks": [
            ("i18n Check", ".agent-os/skills/i18n-localization/scripts/i18n_checker.py", False),
        ]
    },
]
